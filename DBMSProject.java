/*//////////////////////////////////////////////////////////////////////////
//
//  Project name :   Database ManAgment System
//  Description  :   This project is created to replicate the features of database management System. 
//                   In this project considering one specific database.
//                   example -> provide the implementations at the quires and it will perform the operation on that database.
//                   This project is created to understand the internal working of database mangement system.
...
class DBMS
{
  ...
  public void StartDBMS()
  {
    ...
    while(true)
    {
      ...
      {
        if("insert".equals(Tokens[0]))//insert into table student values
        {
...
/*
 C:\Users\Shivani\Desktop>javac DBMSProject.java
C:\Users\Shivani\Desktop>java DBMSProject
DBMS started succesfully...
Table Schema created succesfully...
DBMS : insert into student values shivani 25 89
DBMS : insert into student values radha 24 98
DBMS : insert into student values snehal 28 96
...
Maximum marks are : 98                            //gives the queries according to these other wise gives an error

DBMS : select MIN marks from student
Minimum marks are : 89

DBMS : select SUM marks from student
Sum of marks are : 283

DBMS : select AVG marks from student
Average marks are : 94.0

DBMS : delete from student where RNo = 2
